...
public class DongbaoGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\javaTest\\RCP\\dzh-dongbao-test-v1\\dzh-dongbao-service1\\dzh-dongbao-umsl\\src\\main\\java");
        gc.setAuthor("杜中辉");
        ...
        dsc.setUrl("jdbc:mysql://192.168.241.139:3306/msb_dongbao_test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
